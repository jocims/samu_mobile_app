...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    labelMedium: TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: Colors.black),
    );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w600, color: Colors.white),
    ...
    labelLarge: TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w400, color: Colors.white),
    labelMedium: TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: Colors.white),
    labelSmall: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w400, color: Colors.white.withOpacity(0.5)),
  );
}
